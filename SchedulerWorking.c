...
void Dispatch()
{
    ...
    //                     for(int i=j+1;i<delayQueue.current_size;i++)
    //                     {
    ...
    //             }
    // //delayQueue.currentTask[delayQueue.current_size].delay--;
    ...
    //     newQueue.currentTask[newQueue.current_size-1].priority = -1;
    //     newQueue.current_size--;
    ...
    //else{
        ...
        {
            // if(delayQueue.currentTask[0].delay == 0)
            // {
...
void TaskA(void) //repeated for number of tasks needed
{
	//do something
    printf("Task 1");
    ReRunMe(2);   //If ReRunMe(0), TaskA will infinitely run, do we need to stop it?
}
